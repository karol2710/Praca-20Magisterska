                  ...
                  {globalDomain ? (
                    <>
                      <div className="flex gap-2 items-center">
                        <div className="input-field flex-1 flex items-center px-3 py-2 bg-muted/20 rounded-lg border border-border/50">
                          <span className="text-foreground text-sm">{globalDomain}</span>
                          <span className="text-xs text-foreground/50 ml-2">static</span>
                        </div>
                      </div>
                      <p className="text-xs text-foreground/50">
                        Using domain from Global Configuration. Only one hostname is allowed.
